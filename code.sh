...
python main.py --time 12:00:00 --partition $QUEUE --model $1 humaneval_pass@1 mbpp_pass@1 humaneval-unstripped_pass@1
python main.py --time 24:00:00 --partition $QUEUE --model $1 humaneval_pass@10 humaneval-unstripped_pass@10
