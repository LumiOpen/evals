...
evals = {
    ...
    "goldenswag_mt_bg": LMEvalConfig("ogx_goldenswagx_bg", "acc,norm", num_fewshot=10),
    "goldenswag_mt_cs": LMEvalConfig("ogx_goldenswagx_cs", "acc,norm", num_fewshot=10),
    "goldenswag_mt_da": LMEvalConfig("ogx_goldenswagx_da", "acc,norm", num_fewshot=10),
    "goldenswag_mt_de": LMEvalConfig("ogx_goldenswagx_de", "acc,norm", num_fewshot=10),
    "goldenswag_mt_el": LMEvalConfig("ogx_goldenswagx_el", "acc,norm", num_fewshot=10),
    "goldenswag_mt_es": LMEvalConfig("ogx_goldenswagx_es", "acc,norm", num_fewshot=10),
    "goldenswag_mt_et": LMEvalConfig("ogx_goldenswagx_et", "acc,norm", num_fewshot=10),
    "goldenswag_mt_fi": LMEvalConfig("ogx_goldenswagx_fi", "acc,norm", num_fewshot=10),
    "goldenswag_mt_fr": LMEvalConfig("ogx_goldenswagx_fr", "acc,norm", num_fewshot=10),
    "goldenswag_mt_hu": LMEvalConfig("ogx_goldenswagx_hu", "acc,norm", num_fewshot=10),
    "goldenswag_mt_it": LMEvalConfig("ogx_goldenswagx_it", "acc,norm", num_fewshot=10),
    "goldenswag_mt_lt": LMEvalConfig("ogx_goldenswagx_lt", "acc,norm", num_fewshot=10),
    "goldenswag_mt_lv": LMEvalConfig("ogx_goldenswagx_lv", "acc,norm", num_fewshot=10),
    "goldenswag_mt_nl": LMEvalConfig("ogx_goldenswagx_nl", "acc,norm", num_fewshot=10),
    "goldenswag_mt_pl": LMEvalConfig("ogx_goldenswagx_pl", "acc,norm", num_fewshot=10),
    "goldenswag_mt_pt": LMEvalConfig("ogx_goldenswagx_pt-pt", "acc,norm", num_fewshot=10),
    "goldenswag_mt_ro": LMEvalConfig("ogx_goldenswagx_ro", "acc,norm", num_fewshot=10),
    "goldenswag_mt_sk": LMEvalConfig("ogx_goldenswagx_sk", "acc,norm", num_fewshot=10),
    "goldenswag_mt_sl": LMEvalConfig("ogx_goldenswagx_sl", "acc,norm", num_fewshot=10),
    "goldenswag_mt_sv": LMEvalConfig("ogx_goldenswagx_sv", "acc,norm", num_fewshot=10),

    "goldenswag_mt_bg_0shot": LMEvalConfig("ogx_goldenswagx_bg", "acc,norm", num_fewshot=0),
    "goldenswag_mt_cs_0shot": LMEvalConfig("ogx_goldenswagx_cs", "acc,norm", num_fewshot=0),
    "goldenswag_mt_da_0shot": LMEvalConfig("ogx_goldenswagx_da", "acc,norm", num_fewshot=0),
    "goldenswag_mt_de_0shot": LMEvalConfig("ogx_goldenswagx_de", "acc,norm", num_fewshot=0),
    "goldenswag_mt_el_0shot": LMEvalConfig("ogx_goldenswagx_el", "acc,norm", num_fewshot=0),
    "goldenswag_mt_es_0shot": LMEvalConfig("ogx_goldenswagx_es", "acc,norm", num_fewshot=0),
    "goldenswag_mt_et_0shot": LMEvalConfig("ogx_goldenswagx_et", "acc,norm", num_fewshot=0),
    "goldenswag_mt_fi_0shot": LMEvalConfig("ogx_goldenswagx_fi", "acc,norm", num_fewshot=0),
    "goldenswag_mt_fr_0shot": LMEvalConfig("ogx_goldenswagx_fr", "acc,norm", num_fewshot=0),
    "goldenswag_mt_hu_0shot": LMEvalConfig("ogx_goldenswagx_hu", "acc,norm", num_fewshot=0),
    "goldenswag_mt_it_0shot": LMEvalConfig("ogx_goldenswagx_it", "acc,norm", num_fewshot=0),
    "goldenswag_mt_lt_0shot": LMEvalConfig("ogx_goldenswagx_lt", "acc,norm", num_fewshot=0),
    "goldenswag_mt_lv_0shot": LMEvalConfig("ogx_goldenswagx_lv", "acc,norm", num_fewshot=0),
    "goldenswag_mt_nl_0shot": LMEvalConfig("ogx_goldenswagx_nl", "acc,norm", num_fewshot=0),
    "goldenswag_mt_pl_0shot": LMEvalConfig("ogx_goldenswagx_pl", "acc,norm", num_fewshot=0),
    "goldenswag_mt_pt_0shot": LMEvalConfig("ogx_goldenswagx_pt-pt", "acc,norm", num_fewshot=0),
    "goldenswag_mt_ro_0shot": LMEvalConfig("ogx_goldenswagx_ro", "acc,norm", num_fewshot=0),
    "goldenswag_mt_sk_0shot": LMEvalConfig("ogx_goldenswagx_sk", "acc,norm", num_fewshot=0),
    "goldenswag_mt_sl_0shot": LMEvalConfig("ogx_goldenswagx_sl", "acc,norm", num_fewshot=0),
    "goldenswag_mt_sv_0shot": LMEvalConfig("ogx_goldenswagx_sv", "acc,norm", num_fewshot=0),
