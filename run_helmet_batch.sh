...
case $BATCH in
  ...
  2)
    ...
    python main.py --model LumiOpen/Llama-Poro-2-8B-instruct --backend vllm \
      --project $PROJECT --partition $PARTITION --gres $GRES --time 12:00:00 \
      --apply_chat_template helmet_rag_poro2

    python main.py --model LumiOpen/Llama-Poro-2-8B-instruct --backend vllm \
      --project $PROJECT --partition $PARTITION --gres $GRES --time 12:00:00 \
      --apply_chat_template helmet_rerank_poro2

    python main.py --model LumiOpen/Llama-Poro-2-8B-instruct --backend vllm \
      --project $PROJECT --partition $PARTITION --gres $GRES --time 12:00:00 \
      --apply_chat_template helmet_longqa_poro2

    python main.py --model LumiOpen/Llama-Poro-2-8B-instruct --backend vllm \
      --project $PROJECT --partition $PARTITION --gres $GRES --time 12:00:00 \
      --apply_chat_template helmet_summ_poro2

    python main.py --model LumiOpen/Llama-Poro-2-8B-instruct --backend vllm \
      --project $PROJECT --partition $PARTITION --gres $GRES --time 12:00:00 \
      --apply_chat_template helmet_icl_poro2
    ;;
  ...
  4)
    ...
    python main.py --model meta-llama/Llama-3.1-8B-Instruct --backend vllm \
      --project $PROJECT --partition $PARTITION --gres $GRES --time 12:00:00 \
      --apply_chat_template helmet_rag_short

    python main.py --model meta-llama/Llama-3.1-8B-Instruct --backend vllm \
      --project $PROJECT --partition $PARTITION --gres $GRES --time 12:00:00 \
      --apply_chat_template helmet_rerank_short

    python main.py --model meta-llama/Llama-3.1-8B-Instruct --backend vllm \
      --project $PROJECT --partition $PARTITION --gres $GRES --time 12:00:00 \
      --apply_chat_template helmet_longqa_short

    python main.py --model meta-llama/Llama-3.1-8B-Instruct --backend vllm \
      --project $PROJECT --partition $PARTITION --gres $GRES --time 12:00:00 \
      --apply_chat_template helmet_summ_short

    python main.py --model meta-llama/Llama-3.1-8B-Instruct --backend vllm \
      --project $PROJECT --partition $PARTITION --gres $GRES --time 12:00:00 \
      --apply_chat_template helmet_icl_short
    ;;
