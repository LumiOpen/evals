...
def main():
    ...
    # slurm config
    parser.add_argument('--project', type=str, default="project_2007628", help="Project for sbatch job")
    parser.add_argument('--partition', type=str, default="gpusmall", help="Partition for sbatch job")
    parser.add_argument('--gres', type=str, default="gpu:a100:2", help="gres required for sbatch job")
    parser.add_argument('--time', type=str, default="04:00:00", help="Time limit for sbatch job")
